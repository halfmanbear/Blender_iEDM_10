    ...
    mesh_origin_mode: EnumProperty(
        ...
        items=[
            (
                "APPROX",
                "Approximate",
                "Recover a practical origin from mesh bounds (matches current importer behavior)",
            ),
            (
                "RAW",
                "Raw EDM",
                "Keep raw EDM-local mesh coordinates and do not recenter render-only mesh origins",
            ),
        ],
        default="APPROX",
    )
